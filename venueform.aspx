<%@ Page Language="C#" AutoEventWireup="true" CodeFile="venueform.aspx.cs" Inherits="venueform" %>
<html>
<head>
...
<div id="content">
 ...
 <div style="position:absolute; visibility:show; left: 300px; top: 300px; z-index:2" ><label id="copy" runat="server"> Copy below and paste the code in your web site</label>
    <asp:TextBox id="source" runat="server" Height="76px" Rows="20" TextMode="MultiLine" 
            Width="496px" ></asp:TextBox></div>
</asp:Panel>
