...
public partial class venueform : System.Web.UI.Page
{
    ...
    private void ProcessRequest()
    {
        ...
        try
        {
            ...
            if (Request.QueryString["widget"] == "yes")
            {
                source.Visible = false;
                copy.Visible = false;
            }

            source.Text = "<iframe src='http://foursquare.converselymedia.com/venuelookup.aspx?venue=" + Venue.Text + "&city=" + City.Text + "&state=" + State.Text + "&address=" + Address.Text + "' width='170'  frameborder='0' scrolling='auto' height='800'>";
        }
        catch (Exception ex)
        {
